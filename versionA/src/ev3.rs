...
mod attriute {
    ...
    use crate::ev3::{Ev3Error, Ev3Result};
...
mod driver {
    ...
    use crate::ev3::{utils::OrErr, Attribute, Ev3Error, Ev3Result, Port};
    use std::cell::RefCell;
...
mod device {
    use crate::ev3::{Attribute, Ev3Result};
...
mod findable {
    use crate::ev3::{Device, Ev3Result, Port};
    ...
    ///// #[port = "crate::ev3::motors::MotorPort"]
...
pub mod motors {
    ...
    mod large_motor {
        ...
        use crate::ev3::{Attribute, Device, Driver, Ev3Result, Findable};
        ...
        impl Findable<crate::ev3::motors::MotorPort> for LargeMotor {
            fn get(port: crate::ev3::motors::MotorPort) -> Ev3Result<Self> {
                let name =
    ...
    mod medium_motor {
        ...
        impl Findable<crate::ev3::motors::MotorPort> for MediumMotor {
            fn get(port: crate::ev3::motors::MotorPort) -> Ev3Result<Self> {
                let name =
...
pub mod sensors {
    ...
    pub mod color_sensor {
        ...
        //#[port = "crate::ev3::sensors::SensorPort"]
        ...
        impl Findable<crate::ev3::sensors::SensorPort> for ColorSensor {
            fn get(port: crate::ev3::sensors::SensorPort) -> Ev3Result<Self> {
                let name =
    ...
    pub mod gyro_sensor {
        ...
        impl Findable<crate::ev3::sensors::SensorPort> for GyroSensor {
            fn get(port: crate::ev3::sensors::SensorPort) -> Ev3Result<Self> {
                let name =
    ...
    pub mod infrared_sensor {
        ...
        impl Findable<crate::ev3::sensors::SensorPort> for InfraredSensor {
            fn get(port: crate::ev3::sensors::SensorPort) -> Ev3Result<Self> {
                let name =
    ...
    pub mod touch_sensor {
        ...
        impl Findable<crate::ev3::sensors::SensorPort> for TouchSensor {
            fn get(port: crate::ev3::sensors::SensorPort) -> Ev3Result<Self> {
                let name =
    ...
    pub mod ultrasonic_sensor {
        ...
        impl Findable<crate::ev3::sensors::SensorPort> for UltrasonicSensor {
            fn get(port: crate::ev3::sensors::SensorPort) -> Ev3Result<Self> {
                let name =
...
pub mod led {
    ...
    use crate::ev3::{utils::OrErr, Attribute, Ev3Result};
    use std::fs;
    /// Color type.
...
mod power_supply {
    ...
    use crate::ev3::{utils::OrErr, Attribute, Device, Driver, Ev3Error, Ev3Result};
    use std::fs;
    /// An interface to read data from the system’s power_supply class.
    /// Uses the built-in legoev3-battery if none is specified.
...
pub mod prelude {
    ...
    //! use ev3dev_lang_rust::prelude::*;
    //! ```
    pub use crate::ev3::motors::{DcMotor, Motor, ServoMotor, TachoMotor};
    pub use crate::ev3::sensors::Sensor;
    pub use crate::ev3::Device;
    pub use crate::ev3::Findable;
}
*/